          ...
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7 xl:p-11">
            ...
            <div>
              <form>
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-white bg-black py-3 px-6 rounded-lg border ease-out duration-200 hover:bg-white hover:border hover:text-black mt-7"
                >
                  Sign in to account
                </button>
                ...
                {/* <div className="flex flex-col gap-4 mt-4">
                  <button className="flex justify-center items-center gap-3 rounded-lg border border-gray-3 bg-gray-1 p-3 ease-out duration-200 hover:bg-gray-2">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                ...
                <p className="text-center mt-1">
                  ...
                  <Link
                    href="/signup"
                    className="text-dark ease-out duration-200 text-blue-500 hover:text-blue-700 pl-2"
                  >
                    Sign Up Now!
                  </Link>
                </p>
