          ...
          <div className="flex flex-col xl:flex-row gap-7">
            <div className="xl:max-w-[770px] w-full bg-gray-100 rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              <div className="mb-12 h-44 overflow-y-auto rounded-lg cartSection">
                <div className="px-3 py-3 mb-2 bg-white rounded-md flex justify-between items-center shadow-md relative">
                  <div className="rounded-lg">
                    <Image
                      width={40}
                      height={40}
                      src="https://5.imimg.com/data5/SELLER/Default/2022/2/CP/RT/HZ/107007216/girls-hand-bag.jpeg"
                      alt=""
                    />
                  </div>
                  <div className="w-80">
                  ...
                  <div className="w-fit h-fit  bg-red-100 p-1 rounded-full -top-1 -right-1">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
