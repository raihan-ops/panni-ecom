...
const SingleListItem = ({ item }) => {
  ...
  const handleQuickViewUpdate = () => {
    dispatch({
      type: 'quickView/updateQuickView',
      payload: { ...item },
    });
  };
