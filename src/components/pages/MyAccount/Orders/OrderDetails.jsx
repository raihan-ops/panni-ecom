...
const OrderDetails = ({ orderItem }) => {
  return (
    <>
      ...
      <div className="items-center justify-between border-t border-gray-3 py-5 px-7 hidden md:flex">
        ...
        <div className="min-w-[128px]">
          <p
            className={`inline-block text-custom-sm  py-0.5 px-2 rounded-[30px] capitalize ${
